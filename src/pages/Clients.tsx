  ...
  const renderContent = () => {
        ...
        return <motion.div initial={{
          ...
          duration: 0.3
            ...
            <div className="flex items-center space-x-2">
              <button onClick={() => setActiveWidget(null)} className="text-sm text-gray-300 hover:text-white transition-colors">
                ← Retour
              </button>
    ...
    return <motion.div initial={{
      ...
      duration: 0.3
        ...
        return <motion.div key={widget.id} initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
          ...
          delay: index * 0.1
              ...
              <Card className="cursor-pointer group hover:scale-105 transition-all duration-300 bg-gray-900/50 backdrop-blur-xl border-gray-800 hover:border-gray-700" onClick={() => setActiveWidget(widget.id)}>
                <CardHeader className="absolute inset-0 bg-gradient-to-br from-blue-500/10 to-purple-500/10 opacity-50 group-hover:opacity-70 transition-opacity duration-300">
