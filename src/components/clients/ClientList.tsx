...
const ClientList = () => {
  ...
  return (
    <motion.div 
      ...
      className="space-y-6"
    >
      <div className="rounded-lg bg-gray-900/95 border border-gray-800 p-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
          ...
          <div className="flex flex-col md:flex-row gap-2 w-full md:w-auto">
            ...
            <Dialog open={isNewClientDialogOpen} onOpenChange={setIsNewClientDialogOpen}>
              ...
              <DialogContent className="max-w-[800px] max-h-[90vh] overflow-y-auto bg-gray-900/95 border-gray-800">
        ...
        <motion.div
          ...
          className="bg-gray-900/50 rounded-lg shadow-xl border border-gray-800 backdrop-blur-xl"
        >
          <ClientTable
            clients={mockClients}
            onEdit={handleEdit}
      ...
      {selectedClient && (
        <>
          <Sheet>
            <SheetContent side="right" className="w-[400px] sm:w-[540px] bg-gray-900/95 border-gray-800">
