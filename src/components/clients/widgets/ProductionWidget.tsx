...
import { ProductionStats } from "@/components/production/stats/ProductionStats";
import { DailyProductionCard } from "@/components/production/stats/DailyProductionCard";
import { InProgressCard } from "@/components/production/stats/InProgressCard";
import { PendingCard } from "@/components/production/stats/PendingCard";
import { CancelledCard } from "@/components/production/stats/CancelledCard";
import { CompletionRateCard } from "@/components/production/stats/CompletionRateCard";
...
export function ProductionWidget({ clientId }: ProductionWidgetProps) {
  ...
  const stats = {
    dailyProduction: 150,
    yesterdayProduction: 120,
    inProgressProduction: 45,
    pendingProduction: 30,
    cancelledProduction: 10,
    yesterdayCancelled: 8,
    totalProduction: 200,
    dailyProductionList: [],
  ...
  // Exemple de données pour la liste des productions
  ...
  const handleDailyClick = () => console.log("Daily production clicked");
  const handleInProgressClick = () => console.log("In progress clicked");
  const handlePendingClick = () => console.log("Pending clicked");
  const handleCancelledClick = () => console.log("Cancelled clicked");
  ...
  return (
    <div className="space-y-6">
      ...
      <ProductionStats
        ...
        onCancelledClick={handleCancelledClick}
      />
