...
import { OrderTimeframeWidget } from "./OrderTimeframeWidget";
...
export function OrderWidget({ clientId }: OrderWidgetProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      <OrderTimeframeWidget timeframe="day" clientId={clientId} />
      <OrderTimeframeWidget timeframe="week" clientId={clientId} />
      <OrderTimeframeWidget timeframe="month" clientId={clientId} />
      <OrderTimeframeWidget timeframe="year" clientId={clientId} />
