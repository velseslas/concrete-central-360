                    ...
                    <>
                      ...
                      {selectedEmployee.overtime > 0 && (
                        <tr>
                          ...
                          <td className="text-right py-2">{calculateFinalSalary(selectedEmployee).overtimePay}</td>
                        </tr>
                      )}
                      {selectedEmployee.position === "Commercial" && selectedEmployee.salesVolume > 0 && (
                        <tr>
                          <td className="py-2">Prime de vente ({selectedEmployee.salesVolume} m³ × {bonusPerCubicMeter} DA)</td>
                          <td className="text-right py-2">{calculateFinalSalary(selectedEmployee).salesBonus}</td>
                        </tr>
                      )}
                ...
                <tfoot>
                  <tr className="border-t border-gray-300">
                    ...
                    <td className="text-right py-2 font-bold">
                      {selectedEmployee ? calculateFinalSalary(selectedEmployee).finalSalary : 0} DA
                    </td>
                  </tr>
                </tfoot>
              </table>
